...
class File extends SplFileObject
{
    ...
    /**
     * @description: 获取图片的宽高 2019.04.04 by ming
     *
     * @param {type}
     * @return:
     */
    protected function getImageWidthHight()
    {
    ...
    {
        //getimagesize($_FILES['xxxxx']['tmp_name']);
        if (true === $savename) {
            // 自动生成文件名
        ...
        //$savename .= '_widht-1024_height-768';
        $savename .= $this->getImageWidthHight();
