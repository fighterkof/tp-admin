...
( function(factory) {"use strict";
		...
		$.widget("mn.sDashboard", {
			...
			_constructWidget : function(widgetDefinition) {
				...
				var maximizeButton = $('<div title="Maximize" class=""></div>');
				var deleteButton = $('<div title="Close" class="sDashboard-icon sDashboard-circle-remove-icon Hui-iconfont Hui-iconfont-close"></div>');
				//add delete button
